...
CFLAGS  = -g -O2 -O6 -I$(srcdir)  -D_GNU_SOURCE -I/usr/include -I/usr/include $(DEFS) -DHAVE_CONFIG_H  -fvisibility=hidden -fPIC -Wall -Wextra -MD -MT $@ -MF .$(subst /,_,$@).d -MP
LDFLAGS =   
SOLINK  = -shared -Xlinker -x
LIBS    = 
DISTNAME= chan_dongle-1.1.r34
